...
@ComponentScan("com.tritux.persistence")
@EnableJpaRepositories("com.tritux.persistence.dao")
...
public class PersistenceConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(Environment env) {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] { "com.tritux.entity" });
